...
function  Login() {
  ...
  return (
    ...
    <div className="overflow-hidden style-login">
    <div className="w-full p-6 bg-white rounded-xl shadow-md lg:max-w-md">
      ...
      <form className="mt-6" onSubmit={handleLogin}>
        ...
        <div className="mt-2">
          <button type="submit" className="w-full bg-blue-500 hover:bg-blue-700 text-white font-bold   py-2 mt-2 px-2 h-10 rounded-lg  text-md">
            Iniciar sesión
          </button>
        </div>
      </form>
