  ...
  return (
    ...
    <div className="px-4 py-5 mx-auto sm:px-6 lg:px-8 ">
        ...
        <Image src="/travelapp.svg"
            ...
            <div className="flex mt-8 space-x-6 font-bold text-gray-600">
        ...
        <div className="grid grid-cols-1 gap-8 lg:col-span-2 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <nav className="flex flex-col mt-4 font-bold  space-y-2 text-sm text-gray-600">
